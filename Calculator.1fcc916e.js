...
var _mathOperationsJs = require("./js/math-operations.js");
var _calculatorJs = require("./js/calculator.js");

},{"./js/math-operations.js":"3nqs6","./js/calculator.js":"hfT1R"}],"3nqs6":[function(require,module,exports,__globalThis) {
...
},{}],"hfT1R":[function(require,module,exports,__globalThis) {
var _mathOperations = require("./math-operations");
...
equals.addEventListener("click", (event)=>{
    if (outputs[0].textContent !== "" && outputs[1].textContent !== "" && outputs[2].textContent !== "") {
        const first = Number(outputs[0].textContent);
        const action = outputs[1].textContent;
        const second = Number(outputs[2].textContent);
        if (action === "+") output.textContent = (0, _mathOperations.add)(first, second);
        else if (action === "-") output.textContent = (0, _mathOperations.subtract)(first, second);
        else if (action === "\xd7") output.textContent = (0, _mathOperations.multiply)(first, second);
        else output.textContent = (0, _mathOperations.divide)(first, second);
    }
});

},{"./math-operations":"3nqs6"}]},["6BDg4","fILKw"], "fILKw", "parcelRequireb5b3")

//# sourceMappingURL=Calculator.1fcc916e.js.map
